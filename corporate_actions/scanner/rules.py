...
def rejection_reasons(finding: dict) -> list[str]:
    ...
    if finding.get("average_daily_traded_value_crores") is not None and finding["average_daily_traded_value_crores"] < REJECT_MIN_AVERAGE_DAILY_TRADED_VALUE_CRORES:
