"""Indian (NSE/BSE) stock-analysis report renderers.

Quick card (/fundamentalanalyze, /stock) and DEEP report (/fundamentalreport,
/fund) plus the compact movers row (_fundamentals_lines). All money is INR
(\u20b9, Crore units) and the screener.in sections (annuals/quarters,
promoter/FII/DII holdings, ROCE/ROE) belong here. The US renderer lives in
stock_us.py; shared number/signal helpers in stock_common.py.
"""
