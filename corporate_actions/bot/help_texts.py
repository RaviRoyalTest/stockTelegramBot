...
HELP_TEXT = (
    ...
    "/gappers <i>[2d|3d|window Nd|DATE|DATE DATE] [up|down] [N] [100|500|sp500]</i>\n"
    ...
    "  since the open.\n"
    "  <code>/gappers</code>            \u2192 top 15 gaps today, NIFTY 500\n"
    "  <code>/gappers 2d</code> / <code>3d</code>  \u2192 gaps that opened 2/3 sessions ago\n"
    ...
    "  <code>/gappers down</code>      \u2192 gap-DOWNs only \u00b7 <code>/gappers up</code>\n"
...
ALL_COMMANDS_TEXT = (
    ...
    "  /toplosers [period] [N] [100|500]  \u2192 top falling stocks\n"    "/gappers [2d|3d|window Nd|DATE] [up|down] [N] [100|500|sp500] \u2192 overnight gaps\n"
    "  /gappers 2d | 3d        \u2192 gaps N sessions ago \u00b7 /gappers window 3d \u2192 open vs close N ago\n"
