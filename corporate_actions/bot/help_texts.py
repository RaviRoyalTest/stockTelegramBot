...
HELP_TEXT = (
    ...
    "/gappers <i>[up|down] [N] [100|500|sp500]</i>  \u2192 overnight gap scanner\n"
    "  Shows the gap between the PREVIOUS close and today's OPEN (what\n"
    "  /topgainers &amp; /toplosers don't show - they measure prev close \u2192\n"
    "  current price only), plus the move since the open.\n"
    "  <code>/gappers</code>            \u2192 top 15 gapping stocks, NIFTY 500\n"
    "  <code>/gappers down</code>      \u2192 gap-DOWNs only \u00b7 <code>/gappers up</code>\n"
    "  <code>/gappers sp500</code>     \u2192 S&P 500 gaps \u00b7 <code>/gappers 20 nifty100</code>\n"
...
ALL_COMMANDS_TEXT = (
    ...
    "  /gappers [up|down] [N] [100|500|sp500] \u2192 overnight gaps (prev close \u2192 open)\n"
