...
HELP_TEXT = (
    ...
    "\U0001F7E2 Green = Stock gaining\n"
    "\U0001F53B Red down = Stock falling\n"
    ...
    "  (takes ~1-2 min).\n\n"
    "/screen <i>[FILTERS]</i>  \u2192 fundamental stock screener (web Screener parity)\n"
    "  /screen pe&lt;25 roe&gt;15  \u2192 value screen, top 10 by market cap\n"
    "  /screen div&gt;1.5         \u2192 dividend screen\n"
    "  /screen rsi 50-70 macd    \u2192 momentum (RSI band + MACD bullish)\n"
    "  /screen sector bank n 15  \u2192 15 banking stocks\n"
    "  Filters: pe\u00b7roe\u00b7roce\u00b7div\u00b7debt\u00b7mcap(\u20b9 Cr)\u00b7price\u00b7rsi\u00b7change,\n"
    "  sector, macd, ema200, sort, n (aliases /screener, /filterstocks)\n\n"
    ...
    "  session's moves (e.g. /toplosers 1h shows the final hour).\n\n"
    ...
    "Market-hours gate: live screens (no DATE) run from market open until the\n"
    "end of the session day - IST for NIFTY, ET for S&P 500 / NASDAQ 100 - so\n"
    "after-hours runs still return the last session's moves. Date queries are\n"
    "exempt and work any time.\n"
    ...
    "/watcher             \u2192 big-move alerts (ON by default at 5% \u00b7 NIFTY 100):\n"
    "                       /watcher off, on, set 5, universe nifty500\n"
...
ALL_COMMANDS_TEXT = (
    ...
    "  /myfavourites set /toplosers 1h /news \u2192 replace your favourites\n"
    "  /myfavourites add /watchlist \u2192 append a command\n"
    ...
    "  /watcher on|off|set N|universe U \u2192 big-move alerts (on by default at 5% \u00b7 NIFTY 100)\n"
