...
COMMAND_USAGE = {
    ...
    "/schedule": (
        ...
        "/schedule add at 09:15,15:30 /toplosers 1h  \u2192 daily at BOTH times\n"
        "                         (start + end results, open & close)\n"
        "/schedule add 3h /scan500 us       \u2192 US market hours only (NASDAQ/NYSE)\n"
        "/schedule add 3h /scan500 any      \u2192 no gate - any time\n"
        "/schedule add 3h /cmd in from 09:15 to 15:30  \u2192 run window - fires at\n"
        "                         its start AND end, always\n"
        "/schedule add 3h /cmd in|us   \u2192 interval entries fire EXACTLY every 3h\n"
        "                         (09:15, 12:15...) plus once more at session\n"
        "                         close (15:30 IST / 16:00 ET) - no data lost\n"
        "/schedule add at 09:15 /gappers today  \u2192 daily at 09:15 ONLY - clock\n"
        "                         times you choose fire exactly at those times\n"
