...
| `/harmonic SYMBOL [TIMEFRAME]` | `/harmonic TATATECH 1h` | Harmonic-pattern scan (Gartley/Bat/Butterfly/Crab/Shark) with PRZ, Fibonacci ratios, entry/SL/targets, R:R and final signal. Timeframes: `5m 15m 30m 1h 4h 1d 1w` (default 1d). A bare watchlist position also works (`/harmonic 3`). Not investment advice — entries wait for PRZ confirmation |
