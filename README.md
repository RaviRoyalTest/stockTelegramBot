...
| `/fundamentalreport SYMBOL` | `/fundamentalreport RELIANCE` | DEEP fundamental report for one stock (more detailed than `/fundamentalanalyze`): valuation (P/E, fwd P/E, P/B, P/S, div yield), YoY growth & margins, EPS/book value, balance sheet, analyst targets, QoQ shareholding. Aliases: `/fund`, `/fundamentals` |
