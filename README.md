...
| `/gainers [N]` | `/gainers 50` | Top N day gainers across ALL NIFTY 500 stocks (default 30, up to 100) |
| `/losers [N]` | `/losers 100` | Top N day losers across ALL NIFTY 500 stocks (default 30, up to 100) |
